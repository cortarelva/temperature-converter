...
export default function FormulaKelvintoCelsius() {
return(
    <section className="text-formula-container">
        ...
        <h1 classNamme="text-formula-title">Kelvin to Celsius formula</h1>
        ...
        <h4>How to convert Kelvin to Celsius</h4>
        <p className="text-format">The temperature T in degrees Celsius (°C) 
        is equal to the temperature T in Kelvin (K) minus 273.15:</p>
        <h3>
        T(°C) = T(K) - 273.15
        </h3>
        <h3 className="text-formula-title">Example</h3>
        <p className="text-formula-title">Convert 300 Kelvin to degrees Celsius:</p>
        <h3>T(°C) = 300K - 273.15 = 26.85 °C</h3>
    </section>
);
}